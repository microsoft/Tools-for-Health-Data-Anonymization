...
namespace Fhir.Anonymizer.Core.UnitTests.Processors
{
    ...
    {
        [Fact]
        public async void GivenADateNode_WhenDateShift_DateShiftedNodeShouldBeReturned()
        {
        ...
        [Fact]
        public async void GivenADateTimeNode_WhenDateShift_DateShiftedNodeShouldBeReturn()
        {
            DateShiftProcessor processor = new DateShiftProcessor(dateShiftKey: "dummy", string.Empty, enablePartialDatesForRedact: true);
        ...
        [Fact]
        public async void GivenAInstantNode_WhenDateShift_DateShiftedNodeShouldBeReturn()
        {
            DateShiftProcessor processor = new DateShiftProcessor(dateShiftKey: "dummy", string.Empty, enablePartialDatesForRedact: true);
