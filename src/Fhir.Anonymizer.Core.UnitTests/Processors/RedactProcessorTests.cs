...
namespace Fhir.Anonymizer.Core.UnitTests.Processors
{
    ...
    {
        [Fact]
        public async void GivenADateNode_WhenRedact_RedactedNodeShouldBeReturn()
        {
            ...
            var processResult = await processor.Process(node);
            ...
            processResult = await processor.Process(node);
            Assert.Null(node.Value);
            Assert.True(processResult.IsRedacted);
        }

        [Fact]
        public async void GivenADateTimeNode_WhenRedact_RedactedNodeShouldBeReturn()
        {
            RedactProcessor processor = new RedactProcessor(enablePartialDatesForRedact: true, true, true, new List<string>());
        ...
        [Fact]
        public async void GivenAInstantNode_WhenRedact_RedactedNodeShouldBeReturn()
        {
            RedactProcessor processor = new RedactProcessor(enablePartialDatesForRedact: true, true, true, new List<string>());
        ...
        [Fact]
        public async void GivenAnAgeNode_WhenRedact_RedactedNodeShouldBeReturn()
        {
        ...
        [Fact]
        public async void GivenAPostalCodeNode_WhenRedact_RedactedNodeShouldBeReturn()
        {
        ...
        [Fact]
        public async void GivenAnOtherNode_WhenRedact_RedactedNodeShouldBeReturn()
        {
