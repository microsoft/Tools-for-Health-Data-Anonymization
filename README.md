...
| --validateInput | validateInput | Optional | false | Validate input resources against structure, cardinality and value domains in FHIR [specification](https://www.hl7.org/fhir/validation.html). Detailed report can be found in verbose log. |
| --validateOutput | validateOutput | Optional | false | Validate anonymized resources against structure, cardinality and value domains in FHIR [specification](https://www.hl7.org/fhir/validation.html). Detailed report can be found in verbose log. |
